CREATE TABLE `tb_termination_task_history`  (
  ...
  `json` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '上传的位置信息,json格式',
...
) ENGINE = InnoDB AUTO_INCREMENT = 18282 CHARACTER SET = utf8mb4  COMMENT = '终端历史记录表' ROW_FORMAT = Dynamic;