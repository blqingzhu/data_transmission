CREATE TABLE `tb_termination_task`  (
  ...
  `task_lonlat` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '任务经纬度信息，逗号隔开',
...
) ENGINE = InnoDB AUTO_INCREMENT = 18282 CHARACTER SET = utf8mb4 collate=utf8mb4_general_ci COMMENT = '终端任务表' ROW_FORMAT = Dynamic;