CREATE TABLE `tb_termination_info`  (
  ...
  `lon_lat` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '最近一次经纬度信息，逗号隔开',
  `oilConsume` double(32, 2) NULL DEFAULT NULL COMMENT '最近一次累计油耗',
  `workHours` double(32, 2) NULL DEFAULT NULL COMMENT '最近一次累计工时',
  `prompt_time` datetime(0) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '最近一次上报时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4  collate=utf8mb4_general_ci COMMENT = '终端基础表' ROW_FORMAT = Dynamic;